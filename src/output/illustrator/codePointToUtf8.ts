...
*/
export default function codePointToUtf8Octets(codePoint: number): string[] {
...
*/
function toBinary(codePoint: number): number[] {
  return codePoint
    .toString(2)
    .padStart(8, "0")
    .split("")
...
*/
function prepareOctetHeaders(codePoint: number): number[][] {
  const octets: number[][] = [];
